...
# homewizard_emulator
Some devices, like home EV chargers from Alfen or Peblar can use data from your P1 electricity meter. Alfen and Peblar can use that to slow down the charging-process, and NOT blowup your house main fuse, when needed. They can link with Home Wiard P1 meter for this, but there are several other hardware-solution that effectively do the same thing. If you have a solution, and Homeassistant is getting the data, this emulator can be a solution
